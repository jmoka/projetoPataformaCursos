    ...
    data() {
      return {
        ...
        cursos: [
          ...
          { id: 2, name: 'PHP', to: '/php' },
          { id: 3, name: 'CSS', to: '/css' },
          { id: 4, name: 'HTML', to: '/html' },
          { id: 5, name: 'Node', to: '/node' },
          { id: 6, name: 'Vue.js', to: '/vue' },
          { id: 7, name: 'Vuetify', to: '/vuetify' },
          { id: 8, name: 'Vuex', to: '/vuex' },
          { id: 9, name: 'Nuxt', to: '/nuxt' },
          { id: 10, name: 'Docker', to: '/docker' },
        ],
      };
    },
    components: {
