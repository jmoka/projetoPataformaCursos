          ...
          <v-row>
            <v-col cols="12">
              ...
              <ul>
                ...
                <li>Gerenciamento de Dependências e Bundlers</li>
                <li>Deploy em Servidores Web (GitHub Pages, Netlify, Vercel)</li>
              ...
              <ul>
                ...
                <li>Projetos Finais e Portfólio</li>
                <li>Continuação e Estudos Avançados</li>
              </ul>
              <br>
